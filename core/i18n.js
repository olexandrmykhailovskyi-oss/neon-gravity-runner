...
(function () {
    ...
    const TRANSLATIONS = {
        uk: {
            ...
            'cause.gravity_zone': 'Гравітаційна зона',
            ...
            'editor.title': '🛠 Редактор рівнів',
            'editor.name': 'Назва',
            'editor.defaultName': 'Мій рівень',
            'editor.duration': 'Тривалість',
            'editor.speed': 'Швидкість',
            'editor.density': 'Щільність',
            'editor.starScore': 'Ціль ★★',
            'editor.storm': 'Neon Storm',
            'editor.theme': 'Тема',
            'editor.types': 'Перешкоди',
            'editor.btnPlay': '▶ Тест',
            'editor.btnSave': '💾 Зберегти',
            'editor.btnCode': '📤 Код',
            'editor.btnImport': '📥 Імпорт',
            'editor.promptExport': 'Код рівня:',
            'editor.promptImport': 'Вставте код рівня (NGRL1-…):',
            'editor.saved': 'Рівень збережено',
            'editor.badCode': 'Некоректний код рівня',
            'editor.needType': 'Оберіть хоча б один тип перешкод',
            'editor.deleted': 'Рівень видалено',
            'editor.myLevels': 'Мої рівні',
            'editor.empty': 'Поки немає збережених рівнів',
            'editor.presets': 'Пресети складності',
            'editor.preview': 'Прев’ю',
            ...
            'lb.tabLocal': '🏠 Локальні',
            'lb.tabWorld': '🌍 Світ',
            'lb.allModes': 'Всі',
            'lb.loading': 'Завантаження…',
            'lb.worldEmpty': 'Ще немає світових рекордів — стань першим!',
        ...
        ru: {
            ...
            'cause.gravity_zone': 'Гравитационная зона',
            'cause.pulsar': 'Пульсар',
            ...
            'editor.defaultName': 'Мой уровень',
            'editor.duration': 'Длительность',
            'editor.speed': 'Скорость',
            'editor.density': 'Плотность',
            'editor.starScore': 'Цель ★★',
            'editor.storm': 'Neon Storm',
            'editor.theme': 'Тема',
            'editor.types': 'Препятствия',
            'editor.btnPlay': '▶ Тест',
            'editor.btnSave': '💾 Сохранить',
            'editor.btnCode': '📤 Код',
            'editor.btnImport': '📥 Импорт',
            'editor.promptExport': 'Код уровня:',
            'editor.promptImport': 'Вставьте код уровня (NGRL1-…):',
            'editor.saved': 'Уровень сохранён',
            'editor.badCode': 'Некорректный код уровня',
            'editor.needType': 'Выберите хотя бы один тип препятствий',
            'editor.deleted': 'Уровень удалён',
            'editor.myLevels': 'Мои уровни',
            'editor.empty': 'Сохранённых уровней пока нет',
            'editor.presets': 'Пресеты сложности',
            'editor.preview': 'Превью',
            'editor.random': '🎲 Случайный',
            ...
            'lb.tabLocal': '🏠 Локальные',
            'lb.tabWorld': '🌍 Мир',
            'lb.allModes': 'Все',
            'lb.loading': 'Загрузка…',
            'lb.worldEmpty': 'Мировых рекордов пока нет — стань первым!',
        ...
        en: {
            ...
            'cause.gravity_zone': 'Gravity zone',
            'cause.pulsar': 'Pulsar',
            ...
            'editor.name': 'Name',
            'editor.defaultName': 'My Level',
            'editor.duration': 'Duration',
            'editor.speed': 'Speed',
            'editor.density': 'Density',
            'editor.starScore': '★★ Goal',
            'editor.storm': 'Neon Storm',
            'editor.theme': 'Theme',
            'editor.types': 'Obstacles',
            'editor.btnPlay': '▶ Test',
            'editor.btnSave': '💾 Save',
            'editor.btnCode': '📤 Code',
            'editor.btnImport': '📥 Import',
            'editor.promptExport': 'Level code:',
            'editor.promptImport': 'Paste level code (NGRL1-…):',
            'editor.saved': 'Level saved',
            'editor.badCode': 'Invalid level code',
            'editor.needType': 'Pick at least one obstacle type',
            'editor.deleted': 'Level deleted',
            'editor.myLevels': 'My Levels',
            'editor.empty': 'No saved levels yet',
            'editor.presets': 'Difficulty presets',
            ...
            'lb.allModes': 'All',
            'lb.loading': 'Loading…',
            'lb.worldEmpty': 'No world records yet — be the first!',
