...
> Керуй неоновою частинкою, що мчить крізь кібер-тунель: перемикай гравітацію, долай усі 25 рівнів кампанії, збирай зірки, бонуси та тримай комбо!
...
│   ├── config.js               # Заморожені константи: 25 рівнів, фізика, досягнення
...
│   ├── levels.js               # Менеджер 25 рівнів Кампанії та розрахунок зірок
│   └── game.js                 # Головний ігровий цикл (кампанія, endless, daily)
└── ui/
    ├── ui.js                   # Безпечний DOM-маніпулятор
    ├── screens.js              # Екрани меню, вибір 25 рівнів, перемога із зірками, ТОП-5
...
- **⭐ Кампанія з 25 рівнів**: унікальні випробування, таймери тривалості, щільність перешкод, шторми та оцінка у 1–3 зірки.
